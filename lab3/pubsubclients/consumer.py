...
if __name__ == '__main__':
    ...
    create_subscription("ada2024-450119", "diabetes_res", "diabetes_res_sub")
    pull_message(project="ada2024-450119", subscription="diabetes_res_sub")  # replace your project id
